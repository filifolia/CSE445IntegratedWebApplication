...
namespace HashingDLL
{
    ...
    {
        private static readonly byte[] initVectorBytes = Encoding.ASCII.GetBytes("tw34rfty360t89u2");
        //The keysize necessary to perform the encryption and decryption
        ...
        public static string decryptString(string encryptedInput, string passWord)
        {
